    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.cors().configurationSource(request -> {
            ...
            return cors;
                ...
                .antMatchers(HttpMethod.GET, "/buildings/**").hasAnyRole("USER", "ADMIN", "MODERATOR")
                .antMatchers("/buildings/**").hasRole("ADMIN")
                .antMatchers(HttpMethod.GET, "/rooms/**").hasAnyRole("USER", "ADMIN", "MODERATOR")
                .antMatchers("/rooms/**").hasRole("ADMIN")
                .antMatchers(HttpMethod.GET, "/sections/**").hasAnyRole("USER", "ADMIN", "MODERATOR")
