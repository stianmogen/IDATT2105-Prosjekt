...
export type RoomRegistrationProps = {
  room: Room;
  user: User;
  closeDialog: () => void;
};

const RoomRegistration = ({ room, user, closeDialog }: RoomRegistrationProps) => {
  const classes = useStyles();
  const createRegistration = useCreateRoomRegistration(room.id);
